    ...
    return (
      <div className="animate-fade-in">
        ...
        <div className="text-center py-16">
          ...
          <p className="mt-4 text-gray-400">Projekte werden geladen...</p>
        </div>
      </div>
    );
  }
  return (
    <div className="animate-fade-in">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={onCreate}
          className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500 transition-colors"
        >
      ...
      {projects.length > 0 ? (
        ...
        <div className="text-center py-16 px-6 border-2 border-dashed border-gray-700 rounded-lg">
          ...
          <p className="mt-1 text-sm text-gray-400">Get started by creating a new machine learning project.</p>
          <div className="mt-6">
            <button
              onClick={onCreate}
              type="button"
